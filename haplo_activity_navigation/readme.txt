...
* My items - key entry point for the activity which links to the primary page where the user starts work on an activity.
* Activity menu - for authorised users, a page of menu entries and key statistics for that activity.
