// Tablesort.js - by tristen - used under MIT license.
// https://github.com/tristen/tablesort @ cc43d60ed19afb6a80a9ec0e0adafd130d8dcf1e
// jQuery code added at end to automatically sort tables with tablesort class.
...
;(function () {
    ...
    jQuery(function() {
        jQuery(".tablesort").each(function() {
            var table = new Tablesort(this, {descending:true});
        });
    });
